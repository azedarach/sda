#ifndef SDA_COMPARISON_HELPERS_HPP_INCLUDED
#define SDA_COMPARISON_HELPERS_HPP_INCLUDED
...
struct common_real_type<
   LhsMatrix, RhsMatrix,
   typename std::enable_if<sda::backends::detail::is_eigen_matrix<
                              LhsMatrix>::value &&
                           sda::backends::detail::is_eigen_matrix<
